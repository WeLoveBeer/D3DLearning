...
HRESULT InitDevice()
{
    ...
    {	//front
        { XMFLOAT3( -1.0f, 0.65f, -2.0f ), XMFLOAT2( 0.0f, 1.0f ) },
        { XMFLOAT3( 1.0f, 0.65f, -2.0f), XMFLOAT2(1.0f, 1.0f ) },
        { XMFLOAT3( 1.0f, 1.15f, -2.0f), XMFLOAT2(1.0f, 0.0f) },
        { XMFLOAT3( -1.0f, 1.15f, -2.0f), XMFLOAT2( 0.0f, 0.0f) },
		//back
        { XMFLOAT3(-1.0f, 0.65f, 2.0f), XMFLOAT2(0.0f, 1.0f) },
		{ XMFLOAT3(1.0f, 0.65f, 2.0f), XMFLOAT2(1.0f, 1.0f) },
		{ XMFLOAT3(1.0f, 1.15f, 2.0f), XMFLOAT2(1.0f, 0.0f) },
        ...
        { XMFLOAT3( -1.0f, 1.15f, 2.0f ), XMFLOAT2( 0.0f, 0.0f ) },
		//down
        { XMFLOAT3( -1.0f, 0.65f, -2.0f ), XMFLOAT2( 0.0f, 0.0f ) },
		{ XMFLOAT3(-1.0f, 0.65f, 2.0f), XMFLOAT2(0.0f, 0.0f) },
		{ XMFLOAT3(1.0f, 0.65f, 2.0f), XMFLOAT2(0.0f, 0.0f) },
        { XMFLOAT3( 1.0f, 0.65f, -2.0f ), XMFLOAT2( 0.0f, 0.0f ) },
		...
		//front
		{ XMFLOAT3(-1.0f, 1.15f, -1.2f), XMFLOAT2(0.0f, 1.0f) },
		{ XMFLOAT3(1.0f, 1.15f, -1.2f), XMFLOAT2(1.0f, 1.0f) },
		{ XMFLOAT3(1.0f, 1.6f, -0.2f), XMFLOAT2(1.0f, 0.0f) },
		{ XMFLOAT3(-1.0f, 1.6f, -0.2f), XMFLOAT2(0.0f, 0.0f) },
		//back
		...
		{ XMFLOAT3(1.0f, 1.6f, -0.2f), XMFLOAT2(0.0f, 0.0f) },
		//up
		{ XMFLOAT3(-1.0f, 1.6f, -0.2f), XMFLOAT2(0.0f, 1.0f) },
		{ XMFLOAT3(1.0f, 1.6f, -0.2f), XMFLOAT2(1.0f, 1.0f) },
		{ XMFLOAT3(1.0f, 1.6f, 0.2f), XMFLOAT2(1.0f, 0.0f) },
		{ XMFLOAT3(-1.0f, 1.6f, 0.2f),  XMFLOAT2(0.0f, 0.0f) },
		//wheel,leftface44
		{ XMFLOAT3(-0.1f, 0.0f, 0.0f), XMFLOAT2(0.0f, 0.0f) },
		{ XMFLOAT3(-0.1f, -0.15f, 0.36f), XMFLOAT2(0.0f, 0.0f) },
		{ XMFLOAT3(-0.1f, -0.36f, 0.15f), XMFLOAT2(0.0f, 0.0f) },
		{ XMFLOAT3(-0.1f, -0.36f, -0.15f), XMFLOAT2(0.0f, 0.0f) },
		{ XMFLOAT3(-0.1f, -0.15f, -0.36f), XMFLOAT2(0.0f, 0.0f) },
		{ XMFLOAT3(-0.1f, 0.15f, -0.36f), XMFLOAT2(0.0f, 0.0f) },
		{ XMFLOAT3(-0.1f, 0.36f, -0.15f), XMFLOAT2(0.0f, 0.0f) },
		...
		//floor begin with 86
		{ XMFLOAT3(-50.0f, 0.0f, -50.0f), XMFLOAT2(0.0f, 0.0f) },
		{ XMFLOAT3(50.0f, 0.0f, -50.0f), XMFLOAT2(100.0f, 0.0f) },
		{ XMFLOAT3(50.0f, 0.0f, 50.0f), XMFLOAT2(100.0f, 100.0f) },
		{ XMFLOAT3(-50.0f, 0.0f, 50.0f), XMFLOAT2(0.0f, 100.0f) },
...
void Render()
{
	...
	g_pd3dDevice->CreateDepthStencilState(&dsDesc, &ppDepthStencilState);
	g_pImmediateContext->OMSetDepthStencilState(ppDepthStencilState, 0);
	...
	cb_sky.vMeshColor = g_vMeshColor;
